 ...
 * @author hieu
 */
public class CustomerAddToCartController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            shoppingCart.addToCart(id, price);
            session.setAttribute("cart", shoppingCart);
        } catch (Exception e) {
            log("Error at AddToCartController" + e.getMessage());
        } finally {
            request.getRequestDispatcher("CustomerLoadRoomController").forward(request, response);
        }
    }
