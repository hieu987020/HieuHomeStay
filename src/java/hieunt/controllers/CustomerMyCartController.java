 ...
 * @author hieu
 */
public class CustomerMyCartController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("Error at CustomerMyCartController" + e.getMessage());
        } finally {
            request.getRequestDispatcher("customer/mycart.jsp").forward(request, response);
        }
    }
