<%-- 
    Document   : room
    Created on : 18-Aug-2019, 16:26:50
    Author     : hieu
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <div class="site-wrap">
                                    ...
                                    <nav class="site-navigation text-right" role="navigation">
                                        <div class="container">
                                            ...
                                            <ul class="site-menu js-clone-nav d-none d-lg-block">
                                                ...
                                                <li><a href="/HieuHomeStay/CustomerLoadInfoController">Information</a></li>
                                            </ul>
                                        </div>
                                    </nav>
                                </div>
            ...
            <div class="site-blocks-cover overlay" style="background-image: url(${pageContext.request.contextPath}/haha/noi/sanchua5.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
                <div class="container">
                    <div class="row align-items-center justify-content-center">
                        <div class="col-md-7 text-center" data-aos="fade">
                            <span class="caption mb-3">Otera</span>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 mx-auto text-center mb-5 section-heading">
                            <h2 class="mb-5">Our Rooms & Otera</h2>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <div class="col-md-6 col-lg-4 mb-5">
                                <div class="hotel-room text-center">
                                    ...
                                    <div class="hotel-room-body">
                                        ...
                                        <strong class="price"><font color="red">${dto.price}$ per date</font></strong></br>
                                        <strong class="price">${dto.des}</strong></br>

                                        <div class="col-md-12">
                                            <form action="/HieuHomeStay/CustomerAddToCartController" method="POST">
                                                <input type="hidden" value="${dto.id}" name="id"/>
                                                <input type="hidden" value="${dto.price}" name="price"/>
                                                <input type="submit" value="Add" class="btn btn-primary pill px-4 py-2">
                                            </form>
                                        </div>
                                    </div>
                                </div>
