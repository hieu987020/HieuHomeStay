<%-- 
    Document   : mybillcoin
    Created on : 25-Aug-2019, 02:55:12
    Author     : hieu
--%>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-lg-8 mb-5">
                            <h3 class="h5 text-black mb-3">My Bill Coin</h3>
                            <div class="row form-group">
                                <div class="col-md-12 mb-3 mb-md-0">
                                    <h3 class="h5 text-black mb-3"><font color="red"></font></h3>
                                        <c:if test="${requestScope.INFO != null}">
                                            <c:if test="${not empty requestScope.INFO}" var="checkINFO">
                                                <c:forEach items="${requestScope.INFO}" var="dto" varStatus="counter">
                                                <font color="blue">No: ${counter.count}</font></br>
                                                <font color="brown">ID: ${dto.id}</font></br>
                                                <font color="brown">InfoID: ${dto.infoID}</font></br>
                                                <font color="brown">Coin: ${dto.coin}</font></br> 
                                                <font color="brown">Time: ${dto.time}</font></br>
                                                ------------------------------------------------------</br>
                                            </c:forEach>
                                        </c:if>
                                        <c:if test="${!checkINFO}">
