<%-- 
    Document   : service
    Created on : 18-Aug-2019, 16:27:03
    Author     : hieu
--%>
...
<html lang="en">
  ...
  <div class="site-wrap">
                ...
                <nav class="site-navigation text-right" role="navigation">
                  <div class="container">
                    ...
                    <ul class="site-menu js-clone-nav d-none d-lg-block">
                      ...
                      <li class="active"><a href="/HieuHomeStay/CustomerLoadServiceController">Service</a></li>
    ...
    <div class="site-blocks-cover overlay" style="background-image: url(${pageContext.request.contextPath}/haha/vu/1.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-md-7 text-center" data-aos="fade">
              <span class="caption mb-3">Enjoy our service &amp; drink</span>
          ...
          <div class="col-md-6 col-lg-4 mb-5">
            <div class="hotel-room text-center">
              ...
              <div class="hotel-room-body">
                ...
                <strong class="price">${dto.price}$</strong></br>
                <strong class="price">Description: ${dto.des}</strong>
              </div>
            </div>
          </div>
          </c:forEach>
