<%-- 
    Document   : mybill
    Created on : 18-Aug-2019, 16:27:36
    Author     : hieu
--%>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-lg-8 mb-5">
                            <h3 class="h5 text-black mb-3">My Bill</h3>
                            <c:if test="${not empty requestScope.INFO}">
                                <c:forEach items="${requestScope.INFO}" var="dto" varStatus="counter">
                                    <div class="row">
                                        <div class="col-md-6 col-lg-4 mb-5">
                                            <div class="hotel-room text-center">
                                                <a href="#" class="d-block mb-0 thumbnail"><img src="/HieuHomeStay/haha/an/food5.jpg" alt="Image" class="img-fluid"></a>
                                                <div class="hotel-room-body">
                                                    <h3 class="heading mb-0"><a href="#">Bill ID:${dto.id}</a></h3>
                                                    <c:if test="${dto.time == null}">
                                                        <strong class="price">Date(Pay Bill):Not Yet</strong></br>
                                                    </c:if>
                                                    <c:if test="${dto.time != null}">
                                                        <strong class="price">Date(Pay Bill):${dto.time}</strong></br>
                                                    </c:if>
                                                     
                                                    <c:if test="${dto.approved == false}">
                                                        <strong class="price"><font color="blue">The bill is not approved</font> </strong>
                                                    </c:if>
                                                                                                        
                                                    <div class="col-md-12">
                                                        <form action="/HieuHomeStay/CustomerViewDetailBillController" method="POST">
                                                            <input type="hidden" value="${dto.id}" name="id"/>                                              
                                                            <input type="hidden" value="${dto.approved}" name="isApproved"/>                                              
                                                            <input type="submit" value="ViewDetail" class="btn btn-primary pill px-4 py-2">
                                                        </form>
                                                    </div>                                                  
                                                </div>
                                            </div>
