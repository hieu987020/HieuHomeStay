<%-- 
    Document   : mylevel
    Created on : 18-Aug-2019, 16:27:53
    Author     : hieu
--%>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-lg-8 mb-5">
                            <h3 class="h5 text-black mb-3">My Level & Coin</h3>
                            ...
                            <form action="#" class="p-5 bg-white">
                                <div class="row form-group">
                                    <div class="col-md-12 mb-3 mb-md-0">
                                        ...
                                        <h2><font color="red">Level Infomation</font></h2>
                                            <c:if test="${requestScope.LISTLEVEL != null}">
                                                <c:if test="${not empty requestScope.LISTLEVEL}">
                                                    <c:forEach items="${requestScope.LISTLEVEL}" var="dto" varStatus="counter">
                                                    <font color="blue">Name: ${dto.name}</font></br>
                                                    Discount: ${dto.des}%</br>
                                                    Condition: ${dto.condition}</br>
                                                </c:forEach>
                                            </c:if>
                                        </c:if>
                                        <h2><font color="red">My Level Infomation</font></h2>
                                        <label class="font-weight-bold"><font color="green">My Level ID: ${requestScope.LEVEL.id}</font></label></br>
                                        <label class="font-weight-bold"><font color="green">My Level Name: ${requestScope.LEVEL.name}</font></label></br>
                                        <label class="font-weight-bold"><font color="green">Money Discount: ${requestScope.LEVEL.des}%</font></label></br>
                                        <label class="font-weight-bold"><font color="green">My total's bill price: ${requestScope.TOTAL}$</font></label></br>
                                        </br><br>                
                                        <label class="font-weight-bold"><font color="brown">Description : 1 Bill(5000$ ->) => 100 coin</font></label></br>
                                        <label class="font-weight-bold"><font color="brown">My Coin: ${requestScope.INFO.coin} coin</font></label></br>                                      
                                    </div>                                   
                                </div>
                            </form>
                        </div>
