<%-- 
    Document   : login.jsp
    Created on : 17-Aug-2019, 16:48:13
    Author     : hieu
--%>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-12 col-lg-8 mb-5">
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  <input type="submit" value="Login" name="action" class="btn btn-primary pill px-4 py-2">
                </div>
              </div>
              <div class="row form-group">
                <div class="col-md-12">
                    <a href="/HieuHomeStay/register.jsp">Register</a>
                </div>
              </div>
